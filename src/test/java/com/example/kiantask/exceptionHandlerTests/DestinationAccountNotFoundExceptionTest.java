...
class DestinationAccountNotFoundExceptionTest {
    ...
    void testDefaultConstructor() {
        ...
        assertEquals(GeneralExceptionEnums.DESTINATION_ACCOUNT_NOT_FOUND_EXCEPTION_CODE.getMessage(), exception.getMessage(), "Message should match enum value");
        assertEquals(GeneralExceptionEnums.DESTINATION_ACCOUNT_NOT_FOUND_EXCEPTION_CODE.getCode(), exception.getCode(), "Code should match enum value");
